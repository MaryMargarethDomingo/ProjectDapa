...
public class NDRRMCFragment extends Fragment {
    ...
    public static NDRRMCFragment newInstance() {
        return new NDRRMCFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final UserTimeline userTimeline = new UserTimeline.Builder().screenName("NDRRMC_OpCen").build();

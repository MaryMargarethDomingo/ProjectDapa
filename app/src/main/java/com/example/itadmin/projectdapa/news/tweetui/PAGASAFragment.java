...
public class PAGASAFragment extends Fragment {
    ...
    public static PAGASAFragment newInstance() {
        return new PAGASAFragment();
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.twitter_fragment_pagasa, container, false);
        final RecyclerView recyclerView = view.findViewById(R.id.recycler_view);

        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));

        final UserTimeline userTimeline = new UserTimeline.Builder().screenName("dost_pagasa").build();

...
package com.example.itadmin.projectdapa.survival.survivalContent;
...
import com.example.itadmin.projectdapa.news.controller.PAGASAFragment;
import com.example.itadmin.projectdapa.news.controller.PHIVOLCSFragment;
import com.example.itadmin.projectdapa.survival.survivalWebPages.WebViewEarthquakeFragment;

/**
 * TwitterFragment pages between different timeline Fragments.
 */
public class SurvivalContentPagerEarthquake extends Fragment {
    private static final int PAGE_BEFORE = 0;
    private static final int PAGE_DURING = 1;
    private static final int PAGE_AFTER = 2;

    private static WebViewEarthquakeFragment webViewEarthquake;

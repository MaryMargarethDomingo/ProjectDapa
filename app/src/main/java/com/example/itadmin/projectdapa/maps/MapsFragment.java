...
public class MapsFragment extends Fragment implements OnMapReadyCallback,
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(14.599512, 120.984219), 6));
...
//-------------------------------------------------- ToggleButton - Code --------------------------------------------------
    ...
    CompoundButton.OnCheckedChangeListener changeChecker = new CompoundButton.OnCheckedChangeListener(){
        ...
        public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
            ...
            if(togHospital.isChecked()){
                togHospital.setChecked(true);
            ...
            }else if(togPolice.isChecked()){
                togHospital.setChecked(false);
                togPolice.setChecked(true);
                togFire.setChecked(false);
                togVet.setChecked(false);
            ...
            }else if(togFire.isChecked()){
                togHospital.setChecked(false);
                togPolice.setChecked(false);
                togFire.setChecked(true);
                togVet.setChecked(false);
            ...
            }else if(togVet.isChecked()){
                togHospital.setChecked(false);
                togPolice.setChecked(false);
                togFire.setChecked(false);
                togVet.setChecked(true);

...
import com.example.itadmin.projectdapa.survival.controller.survivalWebPages.WebViewFloodFragment;

/**
 * TwitterFragment pages between different timeline Fragments.
 */
public class SurvivalContentPagerFlood extends Fragment {
    private static final int PAGE_BEFORE = 0;
    private static final int PAGE_DURING = 1;
    private static final int PAGE_AFTER = 2;

    private static WebViewFloodFragment webViewFloodFragment;

package com.example.itadmin.projectdapa.weather.adapter;
...
import com.example.itadmin.projectdapa.weather.model.WeatherViewHolder;
...
public class WeatherRecyclerAdapter extends RecyclerView.Adapter<WeatherViewHolder> {
    ...
    public WeatherViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.weather_listrow, null);
    ...
    public void onBindViewHolder(WeatherViewHolder customViewHolder, int i) {
        ...
        if (sp.getString("speedUnit", "m/s").equals("bft")) {
            customViewHolder.itemyWind.setText(context.getString(R.string.wind) + ": " +
                    UnitConvertor.getBeaufortName((int) wind) + " " + WeatherFragment.getWindDirectionString(sp, context, weatherItem));
        } else {
            customViewHolder.itemyWind.setText(context.getString(R.string.wind) + ": " + new DecimalFormat("#.0").format(wind) + " " +
                    ...
                    + " " + WeatherFragment.getWindDirectionString(sp, context, weatherItem));
        }

...
import com.example.itadmin.projectdapa.survival.controller.survivalWebPages.WebViewTyphoonFragment;

/**
 * TwitterFragment pages between different timeline Fragments.
 */
public class SurvivalContentPagerTyphoon extends Fragment {
    private static final int PAGE_BEFORE = 0;
    private static final int PAGE_DURING = 1;
    private static final int PAGE_AFTER = 2;

    private static WebViewTyphoonFragment webViewTyphoonFragment;
    ...
    public static class TimelinePagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case PAGE_BEFORE:
                   webViewTyphoonFragment = new WebViewTyphoonFragment(0);
                   return webViewTyphoonFragment;

                case PAGE_DURING:
                    webViewTyphoonFragment = new WebViewTyphoonFragment(1);
                    return webViewTyphoonFragment;

                case PAGE_AFTER:
                    webViewTyphoonFragment = new WebViewTyphoonFragment(2);
                    return webViewTyphoonFragment;
